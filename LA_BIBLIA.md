# 📖 LA BIBLIA DE MSBROSS AI - ESTRUCTURA Y MODO DIOS

Esta es la documentación absoluta, inmutable y definitiva del proyecto SERVER-DEV.
**ESTA INFORMACIÓN ESTÁ GRABADA A FUEGO.** Todo Agente o IA que opere en este entorno DEBE leer, comprender y acatar estas reglas y estructura antes de realizar cualquier cambio.
...
### NOTA FINAL DEL MODO DIOS 🧠✨
*"Si vas a modificar un frontend React, **compílalo** y mételo a `/www` antes de empujar. Si vas a tocar un backend Python, asegúrate de actualizar el entorno virtual en el VPS o PM2. Si rompes el proxy, rompes la Matrix entera."*
