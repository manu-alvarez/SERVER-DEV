...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#0A101C]">
      ...
      {/* Sidebar Glass Panel */}
      <aside 
        className={`fixed lg:relative w-72 lg:w-64 flex-shrink-0 glass-panel border-r border-white/5 flex flex-col my-4 ml-4 rounded-2xl overflow-hidden z-50 h-[calc(100vh-2rem)] transition-transform duration-300 ease-in-out bg-[#050B14]/95 lg:bg-transparent backdrop-blur-3xl shadow-[20px_0_40px_rgba(0,0,0,0.5)] lg:shadow-none ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-[150%] lg:translate-x-0'}`}
      >
