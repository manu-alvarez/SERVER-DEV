...
const defaultSettings: Settings = {
  ...
  models: { openai:"gpt-4o", anthropic:"claude-3-5-sonnet-20240620", gemini:"gemini-3.1-pro", groq:"llama3-8b-8192", openrouter:"openai/gpt-4o", custom:"lmstudio-community/Meta-Llama-3-8B-Instruct-GGUF" },
