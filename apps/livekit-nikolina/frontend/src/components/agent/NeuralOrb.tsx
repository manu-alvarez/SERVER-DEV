...
export function NeuralOrb() {
    ...
    switch (roomState) {
      case ConnectionState.Connected:
        return {
          ...
          emoji: '🗣️',
          pulseConfig: { scale: [1, 1.05, 1], transition: { duration: 2, repeat: Infinity, ease: 'easeInOut' } }
        };
  ...
  return (
    <motion.div 
      className="relative w-48 h-48 mx-auto my-8 rounded-full flex items-center justify-center text-6xl shadow-2xl"
    ...
    >
      ...
      <span className="relative z-10 drop-shadow-md">{state.emoji}</span>
    </motion.div>
  );
}
