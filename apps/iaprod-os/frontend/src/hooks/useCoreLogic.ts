...
const OFFLINE_REPLIES: Record<string, string> = {
  hola: '¡Hola! Soy IAProd OS, tu asistente IA personal de élite. ¿En qué puedo ayudarte hoy?',
  hello: 'Hello! I am IAProd OS, your luxury AI assistant. How can I act for you?',
